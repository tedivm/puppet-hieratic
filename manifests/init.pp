...
class hieratic (
  ...
  if(defined('augeas')
    and ($augeas_enabled or $global_enable)) {
      $augeas_config =
  ...
  if(defined('computers')
    and ($computers_enabled or $global_enable)) {
      $computers_config =
  ...
  if(defined('cron')
    and ($cron_enabled or $global_enable)) {
      $cron_config =
  ...
  if(defined('exec')
    and ($exec_enabled or $global_enable)) {
      $exec_config =
  ...
  if(defined('file')
    and ($file_enabled or $global_enable)) {
      $file_config =
  ...
  if(defined('file_line')
    and ($file_line_enabled or $global_enable)) {
      $file_line_config =
  ...
  if(defined('filebucket')
    and ($filebucket_enabled or $global_enable)) {
      $filebucket_config =
  ...
  if(defined('group')
    and ($group_enabled or $global_enable)) {
      $group_config =
  ...
  if(defined('host')
    and ($host_enabled or $global_enable)) {
      $host_config =
  ...
  if(defined('interface')
    and ($interface_enabled or $global_enable)) {
      $interface_config =
  ...
  if(defined('k5login')
    and ($k5login_enabled or $global_enable)) {
      $k5login_config =
  ...
  if(defined('macauthorization')
    and ($macauthorization_enabled or $global_enable)) {
  ...
  if(defined('mailalias')
    and ($mailalias_enabled or $global_enable)) {
      $mailalias_config =
  ...
  if(defined('maillist')
    and ($maillist_enabled or $global_enable)) {
      $maillist_config =
  ...
  if(defined('mcx')
    and ($mcx_enabled or $global_enable)) {
      $mcx_config =
  ...
  if(defined('mount')
    and ($mount_enabled or $global_enable)) {
      $mount_config =
  ...
  if(defined('nagios_command')
    and ($nagios_command_enabled or $global_enable)) {
  ...
  if(defined('nagios_contact')
    and ($nagios_contact_enabled or $global_enable)) {
  ...
  if(defined('nagios_contactgroup')
    and ($nagios_contactgroup_enabled or $global_enable)) {
  ...
  if(defined('nagios_host')
    and ($nagios_host_enabled or $global_enable)) {
      $nagios_host_config =
  ...
  if(defined('nagios_hostdependency')
    and ($nagios_hostdependency_enabled or $global_enable)) {
  ...
  if(defined('nagios_hostescalation')
    and ($nagios_hostescalation_enabled or $global_enable)) {
  ...
  if(defined('nagios_hostextinfo')
    and ($nagios_hostextinfo_enabled or $global_enable)) {
  ...
  if(defined('nagios_hostgroup')
    and ($nagios_hostgroup_enabled or $global_enable)) {
  ...
  if(defined('nagios_service')
    and ($nagios_service_enabled or $global_enable)) {
  ...
  if(defined('nagios_servicedependency')
    and ($nagios_servicedependency_enabled or $global_enable)) {
  ...
  if(defined('nagios_serviceescalation')
    and ($nagios_serviceescalation_enabled or $global_enable)) {
  ...
  if(defined('nagios_serviceextinfo')
    and ($nagios_serviceextinfo_enabled or $global_enable)) {
  ...
  if(defined('nagios_servicegroup')
    and ($nagios_servicegroup_enabled or $global_enable)) {
  ...
  if(defined('nagios_timeperiod')
    and ($nagios_timeperiod_enabled or $global_enable)) {
  ...
  if(defined('notify')
    and ($notify_enabled or $global_enable)) {
      $notify_config =
  ...
  if(defined('package')
    and ($package_enabled or $global_enable)) {
      $package_config =
  ...
  if(defined('resources')
    and ($resources_enabled or $global_enable)) {
      $resources_config =
  ...
  if(defined('router')
    and ($router_enabled or $global_enable)) {
      $router_config =
  ...
  if(defined('scheduled_task')
    and ($scheduled_task_enabled or $global_enable)) {
  ...
  if(defined('selboolean')
    and ($selboolean_enabled or $global_enable)) {
      $selboolean_config =
  ...
  if(defined('selmodule')
    and ($selmodule_enabled or $global_enable)) {
      $selmodule_config =
  ...
  if(defined('service')
    and ($service_enabled or $global_enable)) {
      $service_config =
  ...
  if(defined('ssh_authorized_key')
    and ($ssh_authorized_key_enabled or $global_enable)) {
  ...
  if(defined('ssh_key')
    and ($ssh_key_enabled or $global_enable)) {
      $ssh_key_config =
  ...
  if(defined('stage')
    and ($stage_enabled or $global_enable)) {
      $stage_config =
  ...
  if(defined('tidy')
    and ($tidy_enabled or $global_enable)) {
      $tidy_config =
  ...
  if(defined('user')
    and ($user_enabled or $global_enable)) {
      $user_config =
  ...
  if(defined('vlan')
    and ($vlan_enabled or $global_enable)) {
      $vlan_config =
  ...
  if(defined('yumrepo')
    and ($yumrepo_enabled or $global_enable)) {
      $yumrepo_config =
  ...
  if(defined('zfs')
    and ($zfs_enabled or $global_enable)) {
      $zfs_config =
  ...
  if(defined('zone')
    and ($zone_enabled or $global_enable)) {
      $zone_config =
  ...
  if(defined('zpool')
    and ($zpool_enabled or $global_enable)) {
      $zpool_config =
